import{D as u,I as p,U as x,T as m,aK as P,aL as I,aM as N,aN as C,aO as S}from"./index-C8bJRjxR.js";import{Q as E}from"./quad-BG9aJ5vd.js";var A=`flat out int v_numParticles;
out vec2 v_uv;
void main() {
...
}`;function M({vertices:n,colorsTexture:e,lissajousUniforms:t,displayUniforms:o}){return{data:{draw:u(n,()=>A,()=>F,{uniforms:{lissajousUniforms:t,displayUniforms:o},textures:{colors:{texture:e,sampler:{filter:"nearest",wrap:"clamp"}}}},{blendMode:"alpha"})}}}var h=`#define PI 3.14159265359
vec3 lissajous(
    float t,
    float angle,
    float a,
...
}`;const r=1e3;function b({props:n,quad:e,lissajousUniforms:t,displayUniforms:o}){const c=p({maxInstanceCount:r,attributes:{instanceId:"int"}},{count:r,instances:()=>{const v=[];for(let s=0;s<r;s++)v.push({instanceId:s});return v}},[]),a=x({numLineSegments:"int"},()=>({numLineSegments:r}),[n.time]),i=u(e,()=>h,()=>L,{uniforms:{curveUniforms:a,lissajousUniforms:t,displayUniforms:o},instances:c},{depthTest:!0,blendMode:"alpha"});return{lineSegmentInstances:c,curveUniforms:a,data:{draw:i}}}var O=`#define PI 3.14159265359
vec3 lissajous(
    float t,
    float angle,
    float a,
...
}`;const D=500;function j({props:n,quad:e,numberOfColors:t,colorsTexture:o,lissajousUniforms:c,displayUniforms:a}){const i=p({maxInstanceCount:D,attributes:{instanceId:"int"}},{count:t,instances:()=>{const s=[];for(let f=0;f<t;f++)s.push({instanceId:f});return s}},[]),v=u(e,()=>O,()=>T,{uniforms:{lissajousUniforms:c,displayUniforms:a},instances:i,textures:{colors:{texture:o,sampler:{filter:"nearest",wrap:"edge"}}}},{depthTest:!0,blendMode:"alpha"});return{pointInstances:i,data:{draw:v}}}const l=100;function B(n){const e=x({resolution:"vec2"},()=>({resolution:[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]}),[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]),t=x({lissajous_a:"vec2",lissajous_b:"vec2",lissajous_c:"vec2",numParticles:"int",numMaxParticles:"int",time:"float"},()=>({numParticles:n.colors.length,numMaxParticles:l,time:[n.time],lissajous_a:n.lissajousParams.a,lissajous_b:n.lissajousParams.b,lissajous_c:n.lissajousParams.c}),[n.colors.length,n.time,n.lissajousParams.a,n.lissajousParams.b,n.lissajousParams.c]),o=m({width:l,height:1},()=>{const a=[];for(let i=0;i<l;i++){const v=n.colors[i]||{r:0,g:0,b:0};a.push(v.r*255,v.g*255,v.b*255,255)}return a},[JSON.stringify(n.colors)]),c=E([{x:-1,y:-1,u:0,v:0},{x:1,y:-1,u:1,v:0},{x:1,y:1,u:1,v:1},{x:-1,y:1,u:0,v:1}],[]);return{display_uniforms:e,lissajous_uniforms:t,colors_texture:o,quad:c}}const R={colors:[{r:1,g:1,b:0},{r:0,g:1,b:1},{r:1,g:0,b:1}],time:0,lissajousParams:{a:[1,.6],b:[2,.4],c:[1,1]},general:{canvasDimensions:[800,600]}};function U(n){const e=B(n),t=M({vertices:e.quad,colorsTexture:e.colors_texture,displayUniforms:e.display_uniforms,lissajousUniforms:e.lissajous_uniforms}),o=b({props:n,quad:e.quad,lissajousUniforms:e.lissajous_uniforms,displayUniforms:e.display_uniforms}),c=j({props:n,quad:e.quad,numberOfColors:n.colors.length,colorsTexture:e.colors_texture,lissajousUniforms:e.lissajous_uniforms,displayUniforms:e.display_uniforms});return{outputTexture:m({width:n.general.canvasDimensions[0],height:n.general.canvasDimensions[1]},[t.data.draw,o.data.draw,c.data.draw],[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]),shared_inputs:e,drawGradient:t,drawLissajousCurve:o,drawPoints:c}}function q(n,e){const t={...R,time:n};return U(t)}const z=new P,V=document.getElementById("mainCanvas"),_=V.getContext("webgl2",{antialias:!1});if(!_)throw new Error("Unable to initialize WebGL2");const Y=new N(_),y=new I(Y);z.subscribe((n,e)=>{const t=Object.fromEntries(n);y.submit(e,t),y.draw("outputTexture")});const G=new C;function w(n){const{addedAssets:e,deletedAssetIds:t,graphId:o}=G.update(q(n));S(e[o]),z.transaction(e,t,o)}const d=document.getElementById("inputRange");let g=parseFloat(d.value)/100;d.addEventListener("input",()=>{g=parseFloat(d.value)/100,w(g)});w(g);
