import{A as l,B as d,I as v,aK as g,aL as m,aM as p,aN as f,aO as w}from"./drawGraph-CR9K6HS0.js";import{T as b}from"./triangle-BQ-ZmQWp.js";function x(t){const e=b([{x:-.5,y:-.5,u:0,v:0},{x:.5,y:-.5,u:1,v:0},{x:0,y:.5,u:1,v:1}],[]),a=v({scale:"float"},()=>({scale:[t]}),[t]),n=l({width:1920,height:1080},[d(e,()=>`
        out vec2 uv;
        void main() {
