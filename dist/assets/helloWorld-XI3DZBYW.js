import{V as v,T as d,D as l,aK as p,aL as g,aM as w,aN as m,aO as b}from"./index-Ah9kRPRL.js";function f(t){const e=v({attributes:{pos:"vec2",uv:"vec2"}},{triangleCount:1,vertices:()=>[{pos:[-1,-1],uv:[0,0]},{pos:[0,t],uv:[0,1]},{pos:[1,-1],uv:[1,0]}],indices:()=>[0,1,2]},[t]),n=d({width:1920,height:1080},[l(e,()=>`
                out vec2 v_uv;
                void main() {
