import{D as g,I as p,U as d,T as m,aK as P,aL as I,aM as N,aN as C,aO as S}from"./index-Ah9kRPRL.js";import{Q as E}from"./quad-4GqgEUqo.js";var A=`flat out int v_numParticles;
out vec2 v_uv;
void main() {
    v_numParticles = numParticles;
    v_uv = position;
    gl_Position = vec4(position, 1.0, 1.0);
}`,F=`#define FBM_OCTAVES 1
...
vec4 getColor(vec3 p, float t) {
    ...
    for (int i = 0; i < PCOUNT; ++i) {
        ...
        vec3 p_adj = p * vec3(1.,1.,1.);
        vec3 center_adj = center * vec3(1.,1.,1.);
...
void main() {
    ...
    vec4 col = getColor(sphereSamplePos, time);
    outColor = col;
    
    
    
    
}`;function M({vertices:n,colorsTexture:e,lissajousUniforms:t,displayUniforms:c}){return{data:{draw:g(n,()=>A,()=>F,{uniforms:{lissajousUniforms:t,displayUniforms:c},textures:{colors:{texture:e,sampler:{filter:"nearest",wrap:"clamp"}}}},{blendMode:"alpha"})}}}var h=`#define PI 3.14159265359
vec3 lissajous(
    float t,
    float angle,
    float a,
...
}`;const r=1e3;function b({props:n,quad:e,lissajousUniforms:t,displayUniforms:c}){const o=p({maxInstanceCount:r,attributes:{instanceId:"int"}},{count:r,instances:()=>{const v=[];for(let s=0;s<r;s++)v.push({instanceId:s});return v}},[]),a=d({numLineSegments:"int"},()=>({numLineSegments:r}),[n.time]),i=g(e,()=>h,()=>L,{uniforms:{curveUniforms:a,lissajousUniforms:t,displayUniforms:c},instances:o},{depthTest:!0,blendMode:"alpha"});return{lineSegmentInstances:o,curveUniforms:a,data:{draw:i}}}var O=`#define PI 3.14159265359
vec3 lissajous(
    float t,
    float angle,
    float a,
...
}`;const D=500;function j({props:n,quad:e,numberOfColors:t,colorsTexture:c,lissajousUniforms:o,displayUniforms:a}){const i=p({maxInstanceCount:D,attributes:{instanceId:"int"}},{count:t,instances:()=>{const s=[];for(let f=0;f<t;f++)s.push({instanceId:f});return s}},[]),v=g(e,()=>O,()=>T,{uniforms:{lissajousUniforms:o,displayUniforms:a},instances:i,textures:{colors:{texture:c,sampler:{filter:"nearest",wrap:"edge"}}}},{depthTest:!0,blendMode:"alpha"});return{pointInstances:i,data:{draw:v}}}const l=100;function B(n){const e=d({resolution:"vec2"},()=>({resolution:[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]}),[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]),t=d({lissajous_a:"vec2",lissajous_b:"vec2",lissajous_c:"vec2",numParticles:"int",numMaxParticles:"int",time:"float"},()=>({numParticles:n.colors.length,numMaxParticles:l,time:[n.time],lissajous_a:n.lissajousParams.a,lissajous_b:n.lissajousParams.b,lissajous_c:n.lissajousParams.c}),[n.colors.length,n.time,n.lissajousParams.a,n.lissajousParams.b,n.lissajousParams.c]),c=m({width:l,height:1},()=>{const a=[];for(let i=0;i<l;i++){const v=n.colors[i]||{r:0,g:0,b:0};a.push(v.r*255,v.g*255,v.b*255,255)}return a},[JSON.stringify(n.colors)]),o=E([{x:-1,y:-1,u:0,v:0},{x:1,y:-1,u:1,v:0},{x:1,y:1,u:1,v:1},{x:-1,y:1,u:0,v:1}],[]);return{display_uniforms:e,lissajous_uniforms:t,colors_texture:c,quad:o}}const R={colors:[{r:1,g:1,b:0},{r:0,g:1,b:1},{r:1,g:0,b:1}],time:0,lissajousParams:{a:[1,.6],b:[2,.4],c:[1,1]},general:{canvasDimensions:[800,600]}};function U(n){const e=B(n),t=M({vertices:e.quad,colorsTexture:e.colors_texture,displayUniforms:e.display_uniforms,lissajousUniforms:e.lissajous_uniforms}),c=b({props:n,quad:e.quad,lissajousUniforms:e.lissajous_uniforms,displayUniforms:e.display_uniforms}),o=j({props:n,quad:e.quad,numberOfColors:n.colors.length,colorsTexture:e.colors_texture,lissajousUniforms:e.lissajous_uniforms,displayUniforms:e.display_uniforms});return{outputTexture:m({width:n.general.canvasDimensions[0],height:n.general.canvasDimensions[1]},[t.data.draw,c.data.draw,o.data.draw],[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]),shared_inputs:e,drawGradient:t,drawLissajousCurve:c,drawPoints:o}}function q(n){const e={...R,time:n};return U(e)}const z=new P,V=document.getElementById("mainCanvas"),_=V.getContext("webgl2",{antialias:!1});if(!_)throw new Error("Unable to initialize WebGL2");const Y=new N(_),u=new I(Y);z.subscribe((n,e)=>{const t=Object.fromEntries(n);u.submit(e,t),u.draw("outputTexture")});const G=new C;function Q(n,e){const{addedAssets:t,deletedAssetIds:c,graphId:o}=G.update(q(n));e&&S(t[o]),z.transaction(t,c,o)}const Z=document.getElementById("inputRange");let y=parseFloat(Z.value)/100,x=0;function w(){y=x%300/300,Q(y,x===0),x++,requestAnimationFrame(w)}w();
