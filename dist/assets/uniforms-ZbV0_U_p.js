import{T as l,D as d,U as v,aK as g,aL as m,aM as p,aN as f,aO as w}from"./index-Ah9kRPRL.js";import{T as b}from"./triangle-lN2b_oiO.js";function x(t){const e=b([{x:-.5,y:-.5,u:0,v:0},{x:.5,y:-.5,u:1,v:0},{x:0,y:.5,u:1,v:1}],[]),n=v({scale:"float"},()=>({scale:[t]}),[t]),a=l({width:1920,height:1080},[d(e,()=>`
        out vec2 uv;
        void main() {
