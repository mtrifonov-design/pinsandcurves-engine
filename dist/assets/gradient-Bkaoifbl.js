import{D as l,I as m,U as g,T as u,aK as w,aL as S,aM as A,aN as N,aO as I}from"./drawGraph-BB9Tqwnu.js";import{Q as E}from"./quad-BCAltOAD.js";var C=`flat out int v_numParticles;
out vec2 v_uv;
void main() {
    v_numParticles = numParticles;
    v_uv = position;
    gl_Position = vec4(position, 1.0, 1.0);
}`,L=`#define FBM_OCTAVES 1
...
}`;const r=1e3;function F({props:n,quad:e,lissajousUniforms:t,displayUniforms:c}){const o=m({maxInstanceCount:r,attributes:{instanceId:"int"}},{count:r,instances:()=>{const s=[];for(let v=0;v<r;v++)s.push({instanceId:v});return s}},[]),a=g({numLineSegments:"int"},()=>({numLineSegments:r}),[n.time]),i=l(e,()=>h,()=>b,{uniforms:{curveUniforms:a,lissajousUniforms:t,displayUniforms:c},instances:o},{depthTest:!0,blendMode:"alpha"});return{lineSegmentInstances:o,curveUniforms:a,data:{draw:i}}}var R=`#define PI 3.14159265359
vec3 lissajous(
    float t,
    float angle,
    float a,
...
}`;const T=500;function O({props:n,quad:e,numberOfColors:t,colorsTexture:c,lissajousUniforms:o,displayUniforms:a}){const i=m({maxInstanceCount:T,attributes:{instanceId:"int"}},{count:t,instances:()=>{const v=[];for(let f=0;f<t;f++)v.push({instanceId:f});return v}},[]),s=l(e,()=>R,()=>B,{uniforms:{lissajousUniforms:o,displayUniforms:a},instances:i,textures:{colors:{texture:c,sampler:{filter:"nearest",wrap:"edge"}}}},{depthTest:!0,blendMode:"alpha"});return{pointInstances:i,data:{draw:s}}}const x=100;function U(n){const e=g({resolution:"vec2"},()=>({resolution:[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]}),[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]),t=g({lissajous_a:"vec2",lissajous_b:"vec2",lissajous_c:"vec2",numParticles:"int",numMaxParticles:"int",time:"float"},()=>({numParticles:n.colors.length,numMaxParticles:x,time:[n.time],lissajous_a:n.lissajousParams.a,lissajous_b:n.lissajousParams.b,lissajous_c:n.lissajousParams.c}),[n.colors.length,n.time,n.lissajousParams.a,n.lissajousParams.b,n.lissajousParams.c]),c=u({width:x,height:1},()=>{const a=[];for(let i=0;i<x;i++){const s=n.colors[i]||{r:0,g:0,b:0};a.push(s.r*255,s.g*255,s.b*255,255)}return a},[JSON.stringify(n.colors)]),o=E([{x:-1,y:-1,u:0,v:0},{x:1,y:-1,u:1,v:0},{x:1,y:1,u:1,v:1},{x:-1,y:1,u:0,v:1}],[]);return{display_uniforms:e,lissajous_uniforms:t,colors_texture:c,quad:o}}var D=`out vec2 v_uv;
flat out int v_numParticles;
void main() {
    gl_Position = vec4(position, 0.0, 1.0);
    v_uv = position;
    v_numParticles = numParticles;
}`,j=`#define PI 3.14159265359
vec3 lissajous(
    float t,
    float angle,
    float a,
...
}`;function G({props:n,vertices:e,lissajousUniforms:t,displayUniforms:c}){const o=l(e,()=>D,()=>j,{uniforms:{lissajousUniforms:t,displayUniforms:c},textures:{}},{blendMode:"alpha"});return{texture:u({width:n.general.canvasDimensions[0],height:n.general.canvasDimensions[1]},[o],[n.general.canvasDimensions[0]]),data:{draw:o}}}const q={colors:[{r:Math.pow(24/255,1.5),g:Math.pow(0,1.5),b:Math.pow(97/255,1.5)},{r:Math.pow(79/255,1.5),g:Math.pow(23/255,1.5),b:Math.pow(135/255,1.5)},{r:Math.pow(235/255,1.5),g:Math.pow(52/255,1.5),b:Math.pow(120/255,1.5)},{r:Math.pow(235/255,1.5),g:Math.pow(119/255,1.5),b:Math.pow(60/255,1.5)}],time:0,lissajousParams:{a:[1,.6],b:[2,.4],c:[1,1]},general:{canvasDimensions:[800,600]}};function V(n){const e=U(n),t=G({props:n,vertices:e.quad,displayUniforms:e.display_uniforms,lissajousUniforms:e.lissajous_uniforms}),c=M({vertices:e.quad,colorsTexture:e.colors_texture,displayUniforms:e.display_uniforms,lissajousUniforms:e.lissajous_uniforms,depthSampleTex:t.texture}),o=F({props:n,quad:e.quad,lissajousUniforms:e.lissajous_uniforms,displayUniforms:e.display_uniforms}),a=O({props:n,quad:e.quad,numberOfColors:n.colors.length,colorsTexture:e.colors_texture,lissajousUniforms:e.lissajous_uniforms,displayUniforms:e.display_uniforms}),i=u({width:n.general.canvasDimensions[0],height:n.general.canvasDimensions[1]},[c.data.draw,o.data.draw,a.data.draw],[n.general.canvasDimensions[0],n.general.canvasDimensions[1]]);return{shared_inputs:e,drawGradient:c,drawLissajousCurve:o,drawPoints:a,sampleDepthTex:t,outputTexture:i}}function k(n){const e={...q,time:n};return V(e)}const _=new w,Y=document.getElementById("mainCanvas"),z=Y.getContext("webgl2",{antialias:!1});if(!z)throw new Error("Unable to initialize WebGL2");const K=new A(z),y=new S(K);_.subscribe((n,e)=>{const t=Object.fromEntries(n);y.submit(e,t),y.draw("outputTexture")});const X=new N;function Z(n,e){const{addedAssets:t,deletedAssetIds:c,graphId:o}=X.update(k(n));e&&I(t[o]),_.transaction(t,c,o)}const Q=document.getElementById("inputRange");let p=parseFloat(Q.value)/100,d=0;function P(){p=d%300/300,Z(p,d===0),d+=.5,requestAnimationFrame(P)}P();
