import type { RotatingTexture, VirtualResource, Texture, VertexSignature, InstanceSignature, UniformSignature, VirtualResourceGraph } from "../../src/Types/VirtualResources";
