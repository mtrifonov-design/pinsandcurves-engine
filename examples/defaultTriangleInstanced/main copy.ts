...
import defaultTriangle from './blueprint.ts'
import defaultTriangleInstanced from '../defaultTriangleInstanced/main.ts'
import defaultTriangleInstancedUsedAsTexture from '../defaultTriangleInstancedUsedAsTexture/blueprint.ts'
import drawGraph from '../drawGraph.ts'
import helloWorld from '../helloWorld/blueprint.ts'
import gradient from '../gradient/blueprint.ts'
